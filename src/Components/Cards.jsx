  ...
  return (
    ...
    {cards.map((card) => (
      <div key={card.id} className="bg-white p-4 rounded-lg shadow-md ">
        ...
        />
        <h2 className="text-xl font-semibold mb-2 overflow-hidden line-clamp-2">{card.title}</h2>
        ...
        <p className="text-gray-600 overflow-hidden line-clamp-5">{card.description}</p>
      </div>
    ))}
  </div>
